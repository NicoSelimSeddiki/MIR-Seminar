...
% Option 1: vqt filter bandwidth -> Directly from Wikipedia
% cqtbw = (2 ./ (fbas + gamma)) * Q;
% cqtbw = cqtbw(:);

% alpha = 1 / Q;
% vqtbw = C * (24.7 + 0.108 .* fbas) =
%       = alpha / 0.108 * (24.7 + 0.108 .* fbas) =
%       = alpha / 0.108 * 24.7 + alpha / 0.108 * 0.108 .* fbas =
%       = alpha / 0.108 * 24.7 + alpha .* fbas.
